<footer class="bg-white antialiased dark:bg-gray-800" id="contact">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
          <div class="grid min-w-0 flex-1 grid-cols-2 gap-6 md:gap-8 xl:grid-cols-3">
            <div>
              ...
              <ul class="space-y-3">
                ...
                <li>
                  <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> Career </a>
                </li>
            ...
            <div>
              ...
              <ul class="space-y-3">
                ...
                <li>
                  <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Help Centers</a>
                </li>
                <li>
                  <a href="#" title="" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Policy Information</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              <h6 class="mb-4 text-sm font-semibold uppercase text-gray-900 dark:text-white">Sell on Health Credit</h6>
              <ul class="space-y-3">
                <li>
          ...
          <div class="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
            <div class="space-y-5 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
              <a href="/login" title="" class="text-base font-medium text-primary-700 underline hover:no-underline dark:text-primary-500"> Sign In or Create Account </a>
              ...
              <div>
                <p class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Trade on the go with <a href="#" title="" class="underline hover:no-underline">Health Credit App</a></p>
      ...
      <div class="py-6 md:py-8">
        <div class="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
          <a href="#" title="" class="flex space-x-3 rtl:space-x-reverse">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Health Credit</a>, Inc. All rights reserved.</p>
        </div>
      </div>
    </div>
  </footer>